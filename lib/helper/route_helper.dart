...
class RouteHelper {
  ...
  static Handler _verificationHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
  ...
  static Handler _resetPassHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
  ...
  static Handler _updateAddressHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
...
/*  static Handler _orderSuccessfulHandler = Handler(handlerFunc: (BuildContext context, Map<String, dynamic> params) {
  ...
  static Handler _checkoutHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
  ...
  static Handler _trackOrderHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
  ...
  static Handler _categoryProductsHandlerNew = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
    CategoryProductScreenNew? _categoryProductScreen = ModalRoute.of(context!)!
        .settings
  ...
  static Handler _productDescriptionHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
  ...
  ///...............
  static Handler _productImagesHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
  ...
  ///.................
  static Handler _profileEditHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
